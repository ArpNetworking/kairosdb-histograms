...
public class HistogramPercentRemainingAggregatorTest {
    ...
    private static final List<DataPoint> SINGLE_DOUBLE_GROUP =
            Collections.singletonList(new DoubleDataPoint(1L, 0d));
    private static final List<DataPoint> EMPTY_HIST_GROUP =
            Collections.singletonList(HistogramUtils.createHistogram(1L));
    private static final List<DataPoint> MULTI_HIST_GROUP = Arrays.asList(
                    HistogramUtils.createHistogram(1L, 10d, 20d, 30d, 40d),
                    HistogramUtils.createHistogram(2L, 20d, 30d, 40d, 50d),
